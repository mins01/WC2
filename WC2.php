			...
			<div id="container">
				...
				<aside id="propPanel"  class="wc2-panel " aria-expanded="false" >
					<div class="panel panel-default">
						...
						<div class="panel-body">
								...
								<div class="panel panel-default">
									...
									<div  class="panel-body">
										<table class="" style="width:100%">
											...
											<tr>
												<th>alpha</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="1" step="0.01" name="globalAlpha"  ></div></td></td>
											</tr>
											<tr>
												<th>lineWidth</th>
											...
											<tr>
												<th>X</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="-1000" max="1000" value="0" step="1" name="x"  ></div></td>
											</tr>
											<tr>
												<th>Y</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="-1000" max="1000" value="0" step="1" name="y"  ></div></td>
											</tr>
											<tr>
												<th>multi</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="1" max="1000" value="150" step="1" name="multi"  ></div></td>
											</tr>
											<tr>
												<th>lineLength</th>
								...
								<div class="panel panel-default">
									...
									<div  class="panel-body">
										<table class="" style="width:100%">
											...
											<tr>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="0" step="0.01" name="colorStops_pos1"  ></div></td>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="0" step="0.01" name="colorStops_opacity1"  ></div></td>
											</tr>
											<tr>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="0.2" step="0.01" name="colorStops_pos2"  ></div></td>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="0" step="0.01" name="colorStops_opacity2"  ></div></td>
											</tr>
											<tr>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="0.8" step="0.01" name="colorStops_pos3"  ></div></td>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="0.8" step="0.01" name="colorStops_opacity3"  ></div></td>
											</tr>
											<tr>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="1" step="0.01" name="colorStops_pos4"  ></div></td>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="1" step="0.01" name="colorStops_opacity4"  ></div></td>
											</tr>
										</table>
									</div>
								</div>
								...
								<div class="panel panel-default">
									...
									<div  class="panel-body">
										<table class="" style="width:100%">
											...
											<tr>
												<th>X</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="-1000" max="1000" value="0" step="0" name="x"  ></div></td>
											</tr>
											<tr>
												<th>Y</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="-1000" max="1000" value="0" step="0" name="y"  ></div></td>
											</tr>
											<tr>
												<th>multi</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="1" max="1000" value="150" step="1" name="multi"  ></div></td>
											...
											<tr>
												<th>lineLength</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="1" max="10000" value="1000" step="1" name="lineLength"  ></div></td>
											</tr>
											<tr>
												<th>gapY</th>
											...
											<tr>
												<th>deg</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="-360" max="360" value="45" step="1" name="deg"  ></div></td>
											</tr>
										</table>
									</div>
								</div>
							...
							<form name="formPropText2" id="formPropText2" action="javascript:void(0)" class="wc-tool wc-tool-text2 wc-save-setting" onsubmit="return false" onchange="wc2.cmdTool('predraw')"  oninput="this.onchange()">
								<div class="panel panel-default">
									<div  class="panel-heading">text2</div>
									<div  class="panel-body">
										<table class="" style="width:100%">
											<col width="60">
											<col width="">
								...
								<div class="panel panel-default">
									...
									<div  class="panel-body">
										<table class="">
											...
											<tr>
												<th>Alpha</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="1" step="0.01" name="brushGlobalAlpha"  ></div></td>
											</tr>
											<tr>
												<th>Spacing</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range"  min="0.5" max="10" value="0.5" step="0.01" name="brushSpacing"  ></div></td>
											</tr>
										</table>
									</div>
									...
									<div  class="panel-body">
										<table class="">
											...
											<tr>
												...
												<td ><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range"  min="0" max="1" value="0.1" step="0.01" name="brushMinimumPressureDiameter"  ></div></td>
											</tr>
											<tr>
												<th>Alpha</th>
												<td>
											...
											<tr>
												...
												<td ><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range"  min="0" max="1" value="0.1" step="0.01" name="brushMinimumPressureAlpha"  ></div></td>
											</tr>
										</table>
									</div>
								</div>
								...
								<div class="panel panel-default">
									...
									<div  class="panel-body">
										<table class="">
											...
											<tr>
												<th>Alpha</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="0.5" step="0.01" name="brushGlobalAlpha"  ></div></td>
											</tr>
											<tr>
												<th>Spacing</th>
												<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range"  min="0.5" max="10" value="0.5" step="0.01" name="brushSpacing"  ></div></td>
									...
									<div class="panel panel-default">
										...
										<div  class="panel-body">
											<table class="">
												...
												<tr>
													<th>alpha</th>
													<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" min="0" max="1" value="0.5" step="0.01" name="globalAlpha"  ></div></td>
												</tr>
												<tr>
													<th>Spacing</th>
													<td><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range"  min="0.5" max="10" value="1" step="0.1" name="brushSpacing"  ></div></td>
												</tr>
											</table>
				...
				<article id="hiddenArea" >
					<div id="defaultTabContent">
						...
						<div class="wcb-zoom-box ">
								<!-- <div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2" data-val="1"><input class="wcb-zoom" type="range" value="100" min="1" max="500" step="1"></div> -->
								<!-- <input type="number" class="wcb-zoom" value="100" step="1" min="1" max="500" />% -->
								<select class="btn btn-default btn-sm wcb-zoom">
									<option value="100" disabled>Zoom</option>
										...
										<ul class="list-group ">
											...
											<li class="list-group-item text-center" >
												<div class="row">
													...
													<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2" data-val="128"><input type="range" name="width" value="0" min="0" max="1000" step="1"></div></div>
												</div>
											</li>
											<li class="list-group-item  text-center">
												<div class="row">
									...
									<ul class="list-group ">
										...
										<li class="list-group-item">
											<div class="row">
												...
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="R" value="0" min="-255" max="255"   step="1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<div class="row">
												<div class="col-xs-3"><label>G</label></div>
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="G" value="0" min="-255" max="255"   step="1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<div class="row">
												<div class="col-xs-3"><label>B</label></div>
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="B" value="0" min="-255" max="255"   step="1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<button class="btn btn-default glyphicon glyphicon-ok-circle" type="submit" > OK</button>
									...
									<ul class="list-group ">
										<li class="list-group-item">
											<div class="row">
												...
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="brightness" value="0" min="-1" max="1"   step="0.01"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<div class="row">
												<div class="col-xs-3"><label>Contrast</label></div>
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="contrast" value="1" min="-1" max="1"  step="0.01"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<button class="btn btn-default glyphicon glyphicon-flash" type="button" onclick="this.form.onchange()"> Preview</button>
									...
									<ul class="list-group ">
										<li class="list-group-item">
											<div class="row">
												...
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="threshold" value="128" min="0" max="255" step="1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<div class="row">
												<div class="col-xs-3"><label>Low</label></div>
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="thresholdLow" value="0" min="0" max="255" step="1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<div class="row">
												<div class="col-xs-3"><label>Hight</label></div>
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="thresholdHigh" value="255" min="0" max="255" step="1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<button class="btn btn-default glyphicon glyphicon-flash" type="button" onclick="this.form.onchange()"> Preview</button>
									...
									<ul class="list-group ">
										<li class="list-group-item">
											<div class="row">
												...
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="diameter" value="0" min="0" max="128" step="0.1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<button class="btn btn-default glyphicon glyphicon-flash" type="button" onclick="this.form.onchange()"> Preview</button>
									...
									<ul class="list-group ">
										<li class="list-group-item">
											<div class="row">
												...
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="amount" value="0.5" min="-5" max="5" step="0.1" ></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<div class="row">
												<div class="col-xs-3"><label>Y-Amount</label></div>
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="yamount" value="0.5" min="-5" max="5" step="0.1" onchange="$('#spanYamount').html(this.value);"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<button class="btn btn-default glyphicon glyphicon-flash" type="button" onclick="this.form.onchange()"> Preview</button>
									...
									<ul class="list-group ">
										<li class="list-group-item">
											<div class="row">
												...
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="depthR" value="0" min="2" max="256" step="1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<div class="row">
												<div class="col-xs-3"><label>G depth</label></div>
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="depthG" value="0" min="2" max="256" step="1"></div></div>
											</div>
										</li>
										<li class="list-group-item">
											<div class="row">
												<div class="col-xs-3"><label>B depth</label></div>
												<div class="col-xs-9"><div class="inputRangeBox inputRangeBox-design-1" data-toFixed="2"><input type="range" name="depthB" value="0" min="2" max="256" step="1"></div></div>
											</div>
										</li>
